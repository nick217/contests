 ...
 * Example 1:
   ...
   Example 2:
	...
	all permutation for s2="acd" are: "acd", "adc", "cad", "cda", "dac" and "dca". However, there is 
	not any permutation from s1 which can break some permutation from s2 and vice-versa.
...
public class CheckIfaStringCanBreakAnotherString {
	public boolean checkIfCanBreak(String s1, String s2) {
		...
		boolean worksT1 = true;
		boolean worksT2 = true;
